			...
			if (!this.state.resizing.column) {
				...
				if (dragableColumn != dropableColumn) {
					if (dropableColumn == this.groupAreaName) {
						...
						var _ref = [this.state.groupingColumns.indexOf(dragableColumn), this.state.groupingColumns.indexOf(dropableColumn)],
						    i1 = _ref[0],
						    i2 = _ref[1];

						console.log(dragableColumn);
						console.log(dropableColumn);
						var _ref2 = [this.state.groupingColumns[i2], this.state.groupingColumns[i1]];
						this.state.groupingColumns[i1] = _ref2[0];
						this.state.groupingColumns[i2] = _ref2[1];
					} else {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "vue-table col-sm-12",
      on: {
